...
; 1 column = 2 pixel
; 16x15 pixel characters in 4 colours
; 2x sine movement
...
ss_sine_scroll
	...
	move.l	pf1_construction1(a3),a1 ; destination
	ADDF.W	(visible_pixels_number-ss_sine_char_x_size)/8,a1 ; end of line
	move.l	cl2_construction2(a3),a2 
	ADDF.W	cl2_extension2_entry+cl2_ext2_BLTBPTH+WORD_SIZE,a2
...
ss_sine_scroll_loop2
	...
	ext.l	d0
	MULUF.L pf1_plane_width*pf1_depth3,d0,d1 ; y offset in target
	add.l	a1,d0			; add destination address
	move.w	d0,cl2_ext2_BLTBPTL-cl2_ext2_BLTBPTH(a2) ; playfield read
	addq.w	#ss_text_y_radius_angle_step*WORD_SIZE,d2
	and.w	d5,d2			; remove overflow
	move.w	d0,cl2_ext2_BLTDPTL-cl2_ext2_BLTBPTH(a2) ; playfield write
	swap	d0
	move.w	d0,(a2)			; playfield read
	addq.w	#ss_text_y_angle_step*WORD_SIZE,d3
	and.w	d5,d3			; remove overflow
	move.w	d0,cl2_ext2_BLTDPTH-cl2_ext2_BLTBPTH(a2) ; playfield write
